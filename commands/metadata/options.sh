...
# Created: Sat Dec 19 13:32:55 PST 2015
#
#/ usage: rundeck-keys:metadata  --keypath <>  --url <$RUNDECK_URL> [ --username <$RUNDECK_USER>] [ --password <$RUNDECK_PASSWORD>] [ --apikey <$RUNDECK_APIKEY>] 
